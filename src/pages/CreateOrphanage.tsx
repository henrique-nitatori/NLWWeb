...
export default function CreateOrphanage() {
  ...
  function handleSelectImages(event: ChangeEvent<HTMLInputElement>) {
    ...
    const selectedImagesPrevies = selectedImages.map(image => {
      return URL.createObjectURL(image)
    }) 
    setPreviewImages(selectedImagesPrevies)
  }
  ...
  return (
    <div id="page-create-orphanage">
      ...
      <main>
        <form className="create-orphanage-form" onSubmit={handleSumbit}>
          <fieldset>
            <legend>Dados</legend>
            ...
            <div className="input-block">
              ...
              <input type="file" multiple onChange={handleSelectImages} name="" id="image[]"/>
